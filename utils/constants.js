...
const NOTALLOWEDMSG = 'los invitados no pueden entrar a este curso. por favor acceda con sus datos.';
const NOTALLOWEDMSGEN = 'guests cannot access this course. please log in.';
const NOTALLOWEDMSGFORM = 'los invitados no pueden entrar a este curso. por favor acceda con sus datos.';
...
const URL_TEST_NO_FOLDER_DOWNLOAD = 'https://campus.exactas.uba.ar/course/view.php?id=1790&section=8';
const URL_TEST_VARIOUS_WAYS_DOWNLOADS = 'https://campus.exactas.uba.ar/course/view.php?id=1756&section=2';
